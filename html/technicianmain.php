...
<body>
    <div id="pra1">
        <ul>
            <div id="aac"></div>
            <li><a href="technicianmain.php"><div id="home"></div></a></li>
            <li><a href="videos.php"><div id="videos"></div></a></li>
            <li><a href="aboutus.html">About us</a></li>
            <li><a href="contactus.html">Contact us</a></li>
            <li><input type="search" name="search" placeholder="search here"></li></ul>
            </div>
...
<div id="pra4"><button onclick="techupload()"><div id="aaf"></div></button>
            <button onclick="logOut2()"><div id="aag"></div></button>
</div>
