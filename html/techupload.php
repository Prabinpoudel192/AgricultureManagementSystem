...
<body>
    ...
    <form action="" method="POST" enctype="multipart/form-data">
      <h4><em><bold>Technician upload page.</bold></em></h4>
    <div id="aaa">
    <label>Please choose your file(video file only).</label><br><input type="file" name="file" accept="video/*"><br>
    ...
    if(isset($_POST['post'])){
      ...
      if($con->connect_error){
        die("Error with the connection");
          ...
          $sql="insert into techniciancon(id,comment,image)values('$id','$comment','$file_folder')";
          $r=$con->query($sql);
          if($r>0){
            echo "<script>alert('Data inserted successfully')</script>";
            echo "<script>window.location.href='technicianmain.php';</script>";
          }
          else{
