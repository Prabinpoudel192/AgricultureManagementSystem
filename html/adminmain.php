...
<body>
    <div id="pra1">
        <ul>
            ...
            <li><a href="adminvideos.php"><div id="videos"></div></a></li>
...
while ($row = $ra->fetch_assoc()) {
    ...
    echo "<a href='admindelete.php?val=$id'><button style='height:50px; width: 100px; border-radius:25px; background-color:#A5C01F; float:right; color:white; margin:10px;' >Delete</button></a>";
...
<div id="pra4">
<button onclick="logOut3()"><div id="aag"></div></button>
</div>
